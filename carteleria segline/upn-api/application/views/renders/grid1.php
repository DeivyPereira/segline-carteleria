...
<div style="height: 100vh">
    <div class="row no-gutters">
        ...
        <?php if ($type1 == ".mp4") : ?>
            ...
            <div class="col-6"></div>
        <?php else : ?>
            <div class="col-6" id="grid2" style="background-image: url('<?= BASE_URL; ?>uploads/<?= $grid1; ?>'); background-size: cover; background-position: center; height:100vh;"></div>
        <?php endif; ?>
        ...
        <?php else : ?>
            <div class="col-6" id="grid2" style="background-image: url('<?= BASE_URL; ?>uploads/<?= $grid2; ?>'); background-size: cover; background-position: center; height:100vh;"></div>
        <?php endif; ?>
