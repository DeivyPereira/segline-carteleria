...
<body>
    ...
    <div class="container-fluid">
        <div class="row my-0">
            <?php if ($demo['border'] == 1) : ?>
                <div class="col-12 header">
                    <img src="<?= BASE_URL; ?>/assets/upn-logo.png" width="200" style="margin-top: 15px;">
                </div>
            <?php endif; ?>
            <div class="col-8 top" style="overflow: hidden; position: relative;">
                <?php foreach ($demo['drops']['grid1'] as $item) : ?>
                    <video class="video video-slide">
        ...
        <div class="row my-0">
            <div class="col-4 bottom" id="gridImage">
                <?php foreach ($demo['drops']['grid3'] as $item) : ?>
                    <div class="content-bottom" style="background-image: url('<?= BASE_URL; ?>uploads/<?= $item['name']; ?>'); background-size: 100% 100%;"></div>
                <?php endforeach; ?>
            </div>
            <div class="col-4 bottom" id="gridImage">
                <?php foreach ($demo['drops']['grid4'] as $item) : ?>
                    <div class="content-bottom" style="background-image: url('<?= BASE_URL; ?>uploads/<?= $item['name']; ?>'); background-size: 100% 100%"></div>
                <?php endforeach; ?>
            </div>
            <div class="col-4 bottom" id="gridImage">
                <?php foreach ($demo['drops']['grid5'] as $item) : ?>
                    <div class="content-bottom" style="background-image: url('<?= BASE_URL; ?>uploads/<?= $item['name']; ?>'); background-size: 100% 100%"></div>
                <?php endforeach; ?>
            </div>
        </div>
